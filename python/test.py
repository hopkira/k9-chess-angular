...
click_vel = 150
ACCELERATION = 300
rc.SpeedAccelDistanceM1M2(address=address,accel=ACCELERATION,speed1=int(click_vel),distance1=int(abs(clicks/2)),speed2=int(click_vel),distance2=int(abs(clicks/2)),buffer=1
