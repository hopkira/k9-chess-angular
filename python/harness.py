   ...
   while (test_num < max_tests):
      ...
      while no_collision():
         ...
         while (index < len(sensor_readings)):
            ...
            message = message + "sensor:" + sensor_readings[index][0] + ",x:" + str(dog_x) + ",y:" + str(dog_y) + ",angle:" + str(sensor_readings[index][3]) + ",time:" + str(sensor_readings[index][4]) + ",dist:" + str(sensor_readings[index][5]) + ","
            index = index +1
         message = message[:-1] + "]}"
         #print message
         # ws.send(message)
